...
QUANT_ORDER = ["AJ-IQ2_XXS", "UD-IQ1_S", "UD-IQ1_M", "UD-IQ2_XXS", "UD-Q2_K_XL", "AJ-IQ3_XXS", "Spark-Q2XL-MTP", "AesSedai-IQ2_S", "UD-IQ3_XXS"]
# Messwerte aus docs/RESEARCH.md (unsloth: „Accuracy retained“ = Top-1-Anteil vs. BF16; aj9o9/AesSedai: KLD/Top-1 eigene Angaben)
QUANT_FACTS = {
    "AJ-IQ2_XXS": {"file_gib": 81.4, "kld": 0.7072, "top1": 73.2, "footprint_gib": None},
    "UD-IQ1_S": {"file_gib": 86.7, "kld": None, "top1": 71.0, "footprint_gib": None},
    "UD-IQ1_M": {"file_gib": 90.9, "kld": None, "top1": 73.1, "footprint_gib": None},
    "UD-IQ2_XXS": {"file_gib": 94.8, "kld": None, "top1": 76.0, "footprint_gib": None},
    "UD-Q2_K_XL": {"file_gib": 101.3, "kld": None, "top1": 78.0, "footprint_gib": None},
    "AJ-IQ3_XXS": {"file_gib": 104.7, "kld": 0.3557, "top1": 81.8, "footprint_gib": None},
    "Spark-Q2XL-MTP": {"file_gib": 104.5, "kld": None, "top1": None, "footprint_gib": None},
    "AesSedai-IQ2_S": {"file_gib": 105.8, "kld": 0.3754, "top1": None, "footprint_gib": None},
    "UD-IQ3_XXS": {"file_gib": 112.1, "kld": None, "top1": 82.0, "footprint_gib": None},
}
    ...
    if full:
        ...
        for r in full:
            ...
            add(f"| {r['label']} | {r['passed_tasks']}/{r['total_tasks']} | {r['pass_rate']:.0%} | "
                f"{hm(r['duration_s'])} | {out_tok:,} | {tps:.1f} | {f.get('kld') or '–'} | "
