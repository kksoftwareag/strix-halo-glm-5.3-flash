...
PRESETS: list[Preset] = [
    Preset("unsloth-agent", "unsloth #27754, MTP n5, 128k",
           "Standard für Agenten (ein Nutzer): unsloth-Engine mit MTP, UD-IQ2_XXS, Draft-Tiefe 5 (15,5 t/s bei 8k Tiefe)",
           {"engine": "unsloth", "mtp_enabled": True, "spec_draft_n_max": 5}),
    ...
    Preset("chat-vision", "MTP + Vision-Projektor, 64k, reasoning high",
           "Chat mit Bildern (unsloth mmproj-F16, Schema glm5next)",
           {"engine": "unsloth", "mtp_enabled": True, "vision": True, "ctx_size": 65536, "webui": True, "ubatch": 512, "batch": 2048, "cache_ram_mib": 256}),
    Preset("chat-fast", "MTP, 32k, reasoning low, ngram-mod", "Schneller Chat, kurze Antworten",
           {"engine": "unsloth", "mtp_enabled": True, "ctx_size": 32768, "reasoning_effort": "low",
    ...
    Preset("q2kxl-agent", "UD-Q2_K_XL + MTP (nur mit kleinem VRAM-Carve-out)",
           ...
           {"engine": "unsloth", "mtp_enabled": True, "quant": "UD-Q2_K_XL"}),
